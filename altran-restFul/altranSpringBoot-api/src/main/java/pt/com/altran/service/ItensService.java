...
public class ItensService {
	...
	public ItemDTO createItem(ItemDTO dto) {
		...
		if(repository.findItemEntityByNome(entity.getNome()).isPresent()) 
			throw new ResourceException("Já existe um item cadastrado com o nomem: " + dto.getNome());
	...
	public ItemDTO findById(long id) {
		ItemEntity entity = repository.findById(id)
			.orElseThrow(() -> new ResourceException("Nenhum item encontrado com o id " + id));
	...
	public ItemDTO update(ItemDTO dto) {
		repository.findById(dto.getId())
				.orElseThrow(() -> new ResourceException("Nenhum item encontrado com o id " + dto.getId()));
