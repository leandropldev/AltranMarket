...
public class UsuarioService {
	...
	public UsuarioDTO create(UsuarioDTO dto) {
		...
		if(repository.findUsuarioEntiyByNomeOrEmail(entity.getNome(), entity.getEmail()) != null) 
			throw new RequestException("Já existe um usuario cadastrado com o este nome e/ou email: " + dto.getNome() + "/" + dto.getEmail());
	...
	public UsuarioDTO update(UsuarioDTO dto) {
		repository.findById(dto.getId())
				.orElseThrow(() -> new ResourceNotFoundException("Nenhum Usuario encontrado com o id " + dto.getId()));
